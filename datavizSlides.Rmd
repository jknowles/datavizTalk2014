...
library(knitr)
opts_chunk$set(fig.width=8,fig.height=5.5,message=FALSE,error=FALSE,warning=FALSE,echo=FALSE,dev=c("png"),comment=NA,out.width="750px",out.height="550px", fig.align='center')
library(eeptools)
library(ggplot2)
library(png)
library(grid)
...
![mathgap](assets/HighMathGapClose.png)

## Counterfactual Modeling

![racegapgrad](assets/racegapgradFORAPRIL2014.png)
